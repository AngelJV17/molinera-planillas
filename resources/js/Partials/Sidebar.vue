...
const menuItems = [
    ...
    { name: 'Canjes', routeName: 'attendance-exchanges.index', icon: CalendarCheck2, section: 'personal', activePattern: 'attendance-exchanges.*', permission: 'attendance-exchanges.view' },
