...
const totals = computed(() => {
    const workedDays = props.attendance.days.filter(
        (day) => day.status?.code === "PRESENT",
    ).length;
    const absenceDays = props.attendance.days.filter(
        (day) => day.status?.code === "ABSENT",
    ).length;
    const exchangeDays = props.attendance.days.filter(
        (day) => day.status?.code === "EXCHANGE_WORKED",
    ).length;
    const restDays = props.attendance.days.filter(
        (day) => day.status?.code === "REST",
    ).length;
...
const toggleDaySelection = (day) => {
    ...
    if (selectedDayIds.value.includes(day.id)) {
        selectedDayIds.value = selectedDayIds.value.filter(
            (id) => id !== day.id,
        );
        return;
    }
    ...
    <AuthenticatedLayout title="Calendario de asistencia">
        <section class="space-y-5">
            ...
            <div class="grid gap-5 xl:grid-cols-[1fr_340px]">
                ...
                >
                    <div
                        class="grid gap-5 xl:grid-cols-[1fr_1.15fr] xl:items-start"
                    >
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="min-w-0">
                                <h2
                                    class="text-xl font-black leading-tight text-gray-900"
                                >
                                    {{ attendance.employee.name }}
                                </h2>

                                <p
                                    class="mt-1 text-sm font-semibold text-gray-500"
                                >
                                    Documento:
                                    {{ attendance.employee.document }} · Código:
                        ...
                        <div class="grid gap-2 sm:grid-cols-3">
                            <div
                                class="rounded-2xl border border-primary/20 bg-primary/5 px-3 py-2.5"
                            >
                                <p
                                    class="text-[11px] font-black uppercase tracking-wide text-primary"
                                >
                                    Pendientes
                                </p>
                            ...
                            <div
                                class="rounded-2xl border border-emerald-200 bg-emerald-50 px-3 py-2.5"
                            >
                                <p
                            ...
                            <div
                                class="rounded-2xl border border-red-200 bg-red-50 px-3 py-2.5"
                            >
                                <p
                                    class="text-[11px] font-black uppercase tracking-wide text-red-700"
                                >
                                    Faltó
                                </p>
                            ...
                            <div
                                class="rounded-2xl border border-blue-200 bg-blue-50 px-3 py-2.5"
                            >
                                <p
                                    class="text-[11px] font-black uppercase tracking-wide text-blue-700"
                                >
                                    Canjes
                                </p>
                            ...
                            <div
                                class="rounded-2xl border border-amber-200 bg-amber-50 px-3 py-2.5"
                            >
                                <p
                                    class="text-[11px] font-black uppercase tracking-wide text-amber-700"
                                >
                                    Descansos
                                </p>
                            ...
                            >
                                <p
                                    class="text-[11px] font-black uppercase tracking-wide text-slate-600"
                                >
                                    H. extras
                                </p>

                                <p
                                    class="mt-1 text-xl font-black text-slate-700"
                                >
                ...
                >
                    <div class="space-y-2">
                        ...
                        >
                            ...
                            <p
                                class="text-sm font-semibold leading-relaxed text-slate-600"
                            >
                        ...
                        <div
                            class="flex gap-3 rounded-2xl border border-blue-200 bg-blue-50 p-3"
                        >
                            <Clock3
                            ...
                            <p
                                class="text-sm font-semibold leading-relaxed text-blue-800"
                            >
                        ...
                        <div
                            class="flex gap-3 rounded-2xl border border-amber-200 bg-amber-50 p-3"
                        >
                            <AlertCircle
                            ...
                            <p
                                class="text-sm font-semibold leading-relaxed text-amber-800"
                            >
                                Las horas extras se calculan con el turno
                                asignado.
                            </p>
                        </div>
                    </div>
            ...
            <div class="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
                ...
                >
                        ...
                        >
                            <div>
                                ...
                                <p class="text-xs font-semibold text-gray-500">
                                    Activa la selección múltiple, elige varios
                                    días y aplica un solo estado.
                                </p>

                                <InputError
                                    class="mt-2"
                                    :message="
                                        bulkForm.errors.day_ids ||
                                        bulkForm.errors.status_code
                                    "
                                />
                            </div>
                    ...
                    >
                        <!-- Cabecera de días -->
                        <div
                            class="grid grid-cols-7 border-b border-slate-200 bg-slate-100"
                        >
                            <div
                ...
                >
                    ...
                    >
                        ...
                        <p class="mt-2 text-sm leading-relaxed text-gray-500">
                            Elige un día disponible del calendario. Los días
                            futuros y asistencias cerradas no se pueden editar.
                        </p>
                    </div>
                    ...
                    <form v-else class="space-y-4" @submit.prevent="updateDay">
                        ...
                        <div>
                            ...
                            <InputError
                                class="mt-2"
                                :message="dayForm.errors.status_id"
                            />
                        </div>
                        ...
                        >
                            <div class="mb-3 flex items-start gap-2">
                                ...
                                <div>
                                    ...
                                    <p
                                        class="text-xs font-semibold leading-relaxed text-gray-500"
                                    >
                                        Ingresa las horas transcritas del
                                        cuaderno. El sistema calculará horas
                                        trabajadas y extras.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="grid gap-3 sm:grid-cols-2">
                                <div>
                                    ...
                                    <InputError
                                        class="mt-2"
                                        :message="dayForm.errors.entry_time"
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <InputError
                                        class="mt-2"
                                        :message="dayForm.errors.exit_time"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        >
                            ...
                            >
                                <p
                                    class="text-[11px] font-black uppercase tracking-wide text-slate-500"
                                >
                                    H. trabajadas
                                </p>

                                <p
                                    class="mt-1 text-lg font-black text-slate-800"
                                >
                            ...
                            <div
                                class="rounded-2xl border border-primary/20 bg-primary/5 p-3"
                            >
                                <p
                                    class="text-[11px] font-black uppercase tracking-wide text-primary"
                                >
                        ...
                        >
                            <div class="flex items-start gap-3">
                                ...
                                <p
                                    class="text-xs font-semibold leading-relaxed text-slate-600"
                                >
                                    Este estado no requiere hora de ingreso ni
                                    salida. Si guardas este día, el sistema
                                    limpiará las horas trabajadas y horas
                                    extras.
                                </p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <InputError
                                class="mt-2"
                                :message="dayForm.errors.observation"
                            />
                        </div>
                        ...
                        >
                            <div class="flex items-start gap-3">
                                ...
                                <p
                                    class="text-xs font-semibold leading-relaxed text-blue-800"
                                >
                                    Si este día compensará una falta, márcalo
                                    como “Trabajó como canje”. Después
                                    vincularemos este día con la fecha exacta de
                                    la falta.
                                </p>
                            </div>
                        </div>
