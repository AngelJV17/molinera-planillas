...
<template>
  ...
  <div class="min-h-screen scroll-smooth bg-[#F8F5EC] text-slate-900">
    <!-- NAVBAR -->
    <header
      class="sticky top-0 z-50 border-b border-[#E8DEC8] bg-[#F8F5EC]/95 backdrop-blur-xl"
    >
      <div
      ...
      >
        ...
        >
          ...
          <div class="min-w-0">
            <h1
              class="font-rajdhani text-2xl font-black leading-none text-primary sm:text-3xl"
            >
              MOLICENTE
            </h1>

            <p
              class="hidden text-[11px] font-bold uppercase tracking-[0.16em] text-slate-500 sm:block"
            >
      ...
      <div
        v-if="mobileMenuOpen"
        class="border-t border-[#E8DEC8] bg-white px-4 py-4 shadow-lg lg:hidden"
      >
    ...
    <main>
        ...
        >
          <div class="relative z-10">
            <div class="mb-4 flex items-center gap-3">
              ...
              <span
                class="text-[11px] font-black uppercase tracking-[0.2em] text-secondary sm:text-xs"
              >
            ...
            <h2
              class="max-w-3xl text-4xl font-black leading-[1.02] text-primary sm:text-5xl lg:text-6xl"
            >
            ...
            <p class="mt-5 max-w-xl text-sm leading-relaxed text-slate-600 sm:text-base">
              MOLICENTE centraliza la gestión laboral del molino, reduce tareas manuales y
              organiza la información para planillas y boletas de pago.
            </p>
            ...
            <div
              class="mt-6 flex flex-wrap gap-3 text-xs font-bold text-slate-600 sm:text-sm"
            >
              <span
                class="inline-flex items-center gap-2 rounded-full bg-white px-3 py-2 shadow-sm"
              >
          ...
          <div class="relative min-h-[260px] sm:min-h-[340px] lg:min-h-[430px]">
            ...
            >
              <img
                src="/images/molicente.png"
                alt="Molino MOLICENTE"
      ...
      <section
        id="modulos"
        class="mx-auto max-w-7xl scroll-mt-24 px-4 py-14 sm:px-6 lg:px-8 lg:py-18"
      >
        <div class="mx-auto max-w-3xl text-center">
          ...
          <p class="mt-4 text-sm leading-relaxed text-slate-600 sm:text-base">
            Desde el registro del trabajador hasta el control de asistencia, generación de
        ...
        <div class="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          >
            <div
              class="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#F8F0DA] text-primary"
            >
              <Users class="h-7 w-7" />
            </div>

            <h3 class="mt-5 text-lg font-black text-slate-900">Trabajadores</h3>
          ...
          >
            ...
            <h3 class="mt-5 text-lg font-black text-slate-900">Asistencia</h3>
          ...
          >
            ...
            <h3 class="mt-5 text-lg font-black text-slate-900">Planillas</h3>
          ...
          >
            ...
            <h3 class="mt-5 text-lg font-black text-slate-900">Boletas</h3>
        ...
        >
          <div>
            ...
            <p class="mt-4 max-w-md text-sm leading-relaxed text-slate-600 sm:text-base">
              Una solución pensada para mejorar la gestión administrativa del personal y
          ...
          >
            <div class="border-b border-[#E8DEC8] p-6 text-center sm:border-r">
              ...
              <p class="mt-2 text-sm text-slate-500">Acceso controlado.</p>
            </div>
            ...
            <div class="border-b border-[#E8DEC8] p-6 text-center lg:border-r">
              ...
              <p class="mt-2 text-sm text-slate-500">Procesos ágiles.</p>
            </div>

            <div
              class="border-b border-[#E8DEC8] p-6 text-center sm:border-r lg:border-r-0"
            >
              <BarChart3 class="mx-auto h-8 w-8 text-primary" />
              <h3 class="mt-4 font-black">Centralización</h3>
              <p class="mt-2 text-sm text-slate-500">Datos en un solo lugar.</p>
            </div>

            <div
              class="border-b border-[#E8DEC8] p-6 text-center lg:border-b-0 lg:border-r"
            >
              <Leaf class="mx-auto h-8 w-8 text-primary" />
              <h3 class="mt-4 font-black">Orden</h3>
              <p class="mt-2 text-sm text-slate-500">Mejor seguimiento.</p>
            </div>

            <div
              class="border-b border-[#E8DEC8] p-6 text-center sm:border-b-0 sm:border-r"
            >
              <Users class="mx-auto h-8 w-8 text-primary" />
              <h3 class="mt-4 font-black">Escalable</h3>
              <p class="mt-2 text-sm text-slate-500">Crece con la empresa.</p>
            </div>

            <div class="p-6 text-center">
              <CheckCircle2 class="mx-auto h-8 w-8 text-primary" />
              <h3 class="mt-4 font-black">Especializado</h3>
              <p class="mt-2 text-sm text-slate-500">Para gestión molinera.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        >
          <div class="bg-primary p-8 text-white sm:p-10">
            ...
            <p class="mt-4 text-sm leading-relaxed text-white/75 sm:text-base">
              Industria Molinera San Vicente SRL combina experiencia, compromiso y
              tecnología para mejorar su gestión administrativa.
            </p>
          </div>
          ...
          <div class="grid sm:grid-cols-3">
            ...
            >
              ...
              <p class="mt-2 text-sm text-slate-500">Procesos confiables.</p>
            </div>
            ...
            >
              ...
              <p class="mt-2 text-sm text-slate-500">Equipo humano.</p>
            </div>

            <div class="p-6 text-center">
              <Leaf class="mx-auto h-9 w-9 text-primary" />
              <h3 class="mt-4 font-black">Mejora continua</h3>
              <p class="mt-2 text-sm text-slate-500">Visión de futuro.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        >
          ...
          >
            <div>
              ...
              <p
                class="mt-3 max-w-2xl text-sm leading-relaxed text-white/75 sm:text-base"
              >
                Ingresa al sistema para gestionar trabajadores, asistencia, planillas y
                boletas de pago.
              </p>
            </div>
    ...
    <footer id="contacto" class="scroll-mt-24 bg-primary text-white">
      ...
      >
        <div>
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="font-rajdhani text-2xl font-black">MOLICENTE</p>
      ...
      <div
        class="border-t border-white/10 px-5 py-5 text-center text-xs font-medium text-white/60"
      >
